...
sjcl.random = {
    ...
    switch (typeof a) {
      ...
      default:
        throw new sjcl.exception.bug(
          "random: addEntropy only supports number, array or string"
        );
    }
    this.j[g] += b;
    this.f += b;
  ...
  isReady: function (a) {
    ...
    return this.g && this.g >= a
      ? this.j[0] > 80 && new Date().valueOf() > this.O
        ? 3
        : 1
      : this.f >= a
      ? 2
  ...
  p: function (a) {
    sjcl.random.addEntropy(
      [a.x || a.clientX || a.offsetX, a.y || a.clientY || a.offsetY],
      2,
      "mouse"
    );
  },
...
sjcl.json = {
  ...
  encrypt: function (a, b, c, d) {
    ...
    if (
      ...
      (typeof a === "string" && f.iter <= 100) ||
      (f.ts !== 64 && f.ts !== 96 && f.ts !== 128) ||
      (f.ks !== 128 && f.ks !== 192 && f.ks !== 0x100) ||
      f.iv.length < 2 ||
      f.iv.length > 4
    )
